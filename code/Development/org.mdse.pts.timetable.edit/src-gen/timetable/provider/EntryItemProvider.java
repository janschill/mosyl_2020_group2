...
/**
 * This is the item provider adapter for a {@link timetable.Entry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entry_train_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entry_train_feature", "_UI_Entry_type"),
				 TimetablePackage.Literals.ENTRY__TRAIN,
				 true,
				 false,
				 false,
	...
	protected void addPlatformPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entry_platform_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entry_platform_feature", "_UI_Entry_type"),
				 TimetablePackage.Literals.ENTRY__PLATFORM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TimetablePackage.Literals.ENTRY__TIME);
		}
	...
	public String getText(Object object) {
		String label = ((Entry)object).getTrain();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TimetablePackage.Literals.ENTRY__TIME,
				 TimeFactory.eINSTANCE.createTime()));
	}
