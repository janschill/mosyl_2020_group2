 ...
 * </p>
 * <ul>
 *   <li>{@link schedule.TrainReference#getTrain <em>Train</em>}</li>
 * </ul>
 *
 * @see schedule.SchedulePackage#getTrainReference()
 * @model
 * @generated
 */
public interface TrainReference extends EObject {
	 ...
	 * @see #setTrain(Train)
	 * @see schedule.SchedulePackage#getTrainReference_Train()
	 * @model
	 * @generated
	 */
	Train getTrain();
	...
	/**
	 * Sets the value of the '{@link schedule.TrainReference#getTrain <em>Train</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
