 ...
 * </p>
 * <ul>
 *   <li>{@link org.mdse.pts.schedule.impl.NetworkReferenceImpl#getNetwork <em>Network</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetworkReferenceImpl extends MinimalEObjectImpl.Container implements NetworkReference {
		...
		if (network != null && network.eIsProxy()) {
			...
			if (network != oldNetwork) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SchedulePackage.NETWORK_REFERENCE__NETWORK, oldNetwork, network));
			}
		}
		return network;
	}
	...
	public void setNetwork(Network newNetwork) {
		...
		network = newNetwork;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.NETWORK_REFERENCE__NETWORK, oldNetwork, network));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchedulePackage.NETWORK_REFERENCE__NETWORK:
