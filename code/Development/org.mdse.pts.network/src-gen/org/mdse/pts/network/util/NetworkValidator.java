...
public class NetworkValidator extends EObjectValidator {
	...
	public boolean validateLeg(Leg leg, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateLeg_LegMustCarryNameWhenAnotherLegExistsBtwnSameStations(leg, diagnostics, context);
		return result;
	}
	...
	/**
	 * The cached validation expression for the LegMustCarryNameWhenAnotherLegExistsBtwnSameStations constraint of '<em>Leg</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String LEG__LEG_MUST_CARRY_NAME_WHEN_ANOTHER_LEG_EXISTS_BTWN_SAME_STATIONS__EEXPRESSION = "\n" +
		"\t\t\tnot self.name.oclIsUndefined()";

	/**
	 * Validates the LegMustCarryNameWhenAnotherLegExistsBtwnSameStations constraint of '<em>Leg</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateLeg_LegMustCarryNameWhenAnotherLegExistsBtwnSameStations(Leg leg, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(NetworkPackage.Literals.LEG,
				 leg,
				 ...
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "LegMustCarryNameWhenAnotherLegExistsBtwnSameStations",
				 LEG__LEG_MUST_CARRY_NAME_WHEN_ANOTHER_LEG_EXISTS_BTWN_SAME_STATIONS__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
