...
public class TimetableSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TimetablePackage.ARRIVAL: {
				Arrival arrival = (Arrival)theEObject;
				T result = caseArrival(arrival);
				if (result == null) result = caseEntry(arrival);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TimetablePackage.DEPARTURE: {
				Departure departure = (Departure)theEObject;
				T result = caseDeparture(departure);
				if (result == null) result = caseEntry(departure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TimetablePackage.ENTRY: {
