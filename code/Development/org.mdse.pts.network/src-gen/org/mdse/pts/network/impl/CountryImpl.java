 ...
 * </p>
 * <ul>
 *   <li>{@link org.mdse.pts.network.impl.CountryImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CountryImpl extends MinimalEObjectImpl.Container implements Country {
	...
	protected EClass eStaticClass() {
		return NetworkPackage.Literals.COUNTRY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NetworkPackage.COUNTRY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NetworkPackage.COUNTRY__NAME:
				return getName();
		}
