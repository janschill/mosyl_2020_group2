		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PassengerCoach_class_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PassengerCoach_class_feature", "_UI_PassengerCoach_type"),
				 DepotPackage.Literals.PASSENGER_COACH__CLASS,
				 true,
				 false,
				 false,
